      ...
      <Form onSubmit={remove}>
        ...
        <Col lg={6} style={{ marginLeft: "25%" }}>
          ...
          <InputGroup style={{ marginTop: "5%" }} >
            ...
            <Button className='remove1' type='submit' >Remove </Button>
            </div>
        ...
        <Row>
          <Col lg={4} style={{ marginLeft: "30%", marginTop: "50px" }}>
            <InputGroup className="mb-3">
              ...
              />
              <div className='add'>
              <Button className='add2' onClick={addRow} >ADD </Button>
        ...
        <Row>
          <Col lg={4} style={{ marginLeft: "30%", marginTop: "50px" }}>
            <InputGroup className="mb-3">
              ...
              />
              <div className='show'>
              <Button className='show1' onClick={removeRow} >Show</Button>
              </div>
